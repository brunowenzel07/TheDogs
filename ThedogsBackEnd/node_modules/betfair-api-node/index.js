...
class Betfair {
    ...
    constructor(appKey, username, password, keepAlive) {
        this.appKey = appKey;
        this.authKey = 'nlge14GGZVW2qZKcYECf9Tm0Su3PhIM3XNPp+Zwb6ek=';
        this.username = username || '';
        this.password = password || '';
        this.keepAlive = keepAlive || false;
        this.keepAliveTimeout = 3600;
        this.locale = 'pt_BR';
    ...
    */
     ...
     * @return {Promise<Array>} - Promise that resolves with the results in an array
     */
    listMarketCatalogue(filter, maxResults, marketProjection, opts = {}, ) {
    ...
    devApi(method, params) {
        ...
        console.log("aki passo 2 " + JSON.stringify(def))
    ...
    accountsApi(method, params) {
        ...
        return this.request('identitysso.betfair.com', '/api.betfair.com/exchange/account/json-rpc/v1', 'application/json', JSON.stringify(def));
    }
